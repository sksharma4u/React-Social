        ...
        <>
            <Container>
                ...
                <Col lg={3}>
                    ...
                    <Col lg={6} className="row m-0 p-0">
                        <Col sm={12} >
                            <Card id="post-modal-data" className="card-block card-stretch card-height">
                                ...
                                <Modal size="lg" id="post-modal" show={show} onHide={handleClose}  >
                                    <Modal.Header  className="d-flex justify-content-between">
                                        <Modal.Title id="post-modalLabel">Create Post</Modal.Title>
                                        <button type="button" className="btn btn-secondary " ><i className="ri-close-fill"></i></button>
                                    </Modal.Header>
                                    <Modal.Body>
                                        <div className="d-flex align-items-center">
                                            <div className="user-img">
                                        ...
                                        <button type="submit" className="btn btn-primary d-block w-100 mt-3" onClick ={handleClose} >Post</button>
                                    </Modal.Body>
                                </Modal>
                            </Card>
                        </Col>
